...
*/
    private function textIni ( ) : void
    {
      ...
      texts [ application . getTexts ( ) . SETTING_BACKGROUND_LIVE ] = [ "Background is live." ] ;
      texts [ application . getTexts ( ) . SETTING_BACKGROUND_FIXED ] = [ "Background is fixed." ] ;
      ...
      texts [ application . getTexts ( ) . COMPONENTS_USAGE ] = [ "<p><b>Welcome to KissAs3Fw framework!</b></p>" + application . EMPTY_HTML_PARAGRAPH + "<p>The usage of this component set is readable below.</p>" + application . EMPTY_HTML_PARAGRAPH + "<p><i>If two rectangles can be found in each other then the content can be moved after a left mouse button down (on a clean area).</i></p>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ButtonBar</b>" + "<li><u>A set of ButtonLinks.</u></li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ButtonDraw</b>" + "<li><u>A button object with drawed shape.</u></li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ButtonLink</b>" + "<li><u>A link object which is clickable.</u></li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ButtonText</b>" + "<li><u>Simple button object with displayed text.</u></li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>Checkbox</b>" + "<li><u>Checkbox..</u></li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>Color</b>" + "<li><u>Color chooser panel.</u></li>" + "<li>Selecting the default color: click on the default color shape.</li>" + "<li>Get any color from the stage: click on the temporary color shape.</li>" + "<li>Specify any color with RGB: type into the input field.</li>" + "<li>Selecting predefined color: click on the small rects or on the colored bar.</li>" + "<li>Color commit: click on the OK button.</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ColorPicker</b>" + "<li><u>Selects a color with the Color object.</u></li>" + "<li>To get work: click on the colored shape.</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ContentMultiple</b>" + "<li><u>Content handler object (multiple pages).</u></li>" + "<li>On the settings panel for example.</li>" + "<li>Content selecting: click on the Button bar.</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ContentSingle</b>" + "<li><u>Content handler object (1 page)</u></li>" + "<li>Inside every single Widget.</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>List</b>" + "<li><u>A set of one or more selectable items.</u></li>" + "<li>Select: click on an item.</li>" + "<li>Position: mouse down on the list and drag.</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ListPicker</b>" + "<li><u>List having one selectable item, in one line.</u></li>" + "<li>(Like combobox.)</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>Potmet</b>" + "<li><u>Displays numbers between ranges.</u></li>" + "<li>Minimum maximum and increment values.</li>" + "<li>Precision can be set.</li>" + "<li>Value changing: click on potmet and drag.</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>TextArea</b>" + "<li><u>To edit multiline texts.</u></li>" + "<li>Position: mouse down on the text area and drag</li>" + "<li>Edit mode: click on the text.</li>" + "<li>Read mode: click elsewhere.</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>TextBox</b>" + "<li><u>To display multiline texts.</u></li>" + "<li>Position: mouse down on the text area and drag</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>TextInput</b>" + "<li><u>Single line input field.</u></li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>TextLabel</b>" + "<li><u>To display single line or multi line texts.</u></li>" + "<li>3 types (different font colors)</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>Widget</b>" + "<li><u>To handle content belong each other.</u></li>" + "<li>Position: mouse down on the header area and drag</li>" + "<li>Resize: mouse down on the edge of the widget and drag</li>" + "<li>Hide - unhide: click on the header area</li>" + "<li>Navigate: click on the = icon (on every widgets)</li>" + "<li>Close: double click on the header label</li>" + "</ul>" + application . EMPTY_HTML_PARAGRAPH ] ;
    }
/*
