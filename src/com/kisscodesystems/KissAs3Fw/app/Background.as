...
// Registering onto the events which can modify this object.
      ...
      application . getBaseEventDispatcher ( ) . addEventListener ( application . EVENT_BACKGROUND_IMAGE_OR_ALIGN_OR_ALPHA_CHANGED , backgroundImageChanged ) ;
...
// 1: unregister every event listeners added to different than local_var . getBaseEventDispatcher ( )
      ...
      application . getBaseEventDispatcher ( ) . removeEventListener ( application . EVENT_BACKGROUND_IMAGE_OR_ALIGN_OR_ALPHA_CHANGED , backgroundImageChanged ) ;
